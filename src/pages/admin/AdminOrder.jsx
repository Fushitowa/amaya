	...
	return (
		<div className={`admin-orders-page ${sidebarCollapsed ? "sidebar-collapsed" : ""}`}>
			<aside className="admin-orders-sidebar">
				<div className="admin-orders-brand"><SidebarLogoButton logo={amayaLogo} alt="Amaya logo" collapsed={sidebarCollapsed} onToggle={toggleSidebar} /><div><strong>Amaya</strong><span>Admin Portal</span></div></div>
